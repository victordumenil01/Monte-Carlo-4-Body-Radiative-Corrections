...
def sampleEvents(A, Z, Delta, mi, MF, MGT, nTotal, file_path, final_nucleus):
    ...
    # ── Figures ──
    bins   = np.linspace(me, Delta, int(Q/10)+1)
    ...
    np.savetxt("hist/hist_electron_spectrum_"+final_nucleus+".txt",
    ...
    np.savetxt("hist/hist_radiative_ratio_"+final_nucleus+".txt",
    ...
    np.savetxt("hist/hist_recoil_spectrum_"+final_nucleus+".txt",
    ...
    np.savetxt("hist/hist_recoil_residual_"+final_nucleus+".txt",
               np.column_stack([bins_r[:-1], (hist_S_r + hist_H_r) / hist_0_r - r_rho/100]),
               header="Er_bin_center  residual",
               fmt="%.6e")

    print("Histograms saved in :")
    print("  /hist/hist_electron_spectrum_"+final_nucleus+".txt")
    print("  /hist/hist_radiative_ratio_"+final_nucleus+".txt")
    print("  /hist/hist_recoil_spectrum_"+final_nucleus+".txt")
    print("  /hist/hist_recoil_residual_"+final_nucleus+".txt")
